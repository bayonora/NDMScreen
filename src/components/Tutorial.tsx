  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          <li><strong className="text-[#c1a063]">Añadir desde Grupo:</strong> El botón "Añadir a Iniciativa" te permite traer cualquier Personaje, NPC o Criatura de tu base de datos directamente al combate, introduciendo la tirada que hayan sacado.</li>
          <li><strong className="text-[#c1a063]">Combatientes Temporales:</strong> Si surge un combate imprevisto (ej. bandidos genéricos), usa la opción 'Temporal' para añadirlos sin que se guarden permanentemente en tu bestiario, manteniendo la base de datos limpia.</li>
          <li><strong className="text-[#c1a063]">Mecánica de Salud Rápida:</strong> La casilla de HP soporta matemáticas en vivo. No calcules mentalmente: si un goblin de 30 HP recibe 12 de daño, simplemente haz clic en su salud, escribe <code className="text-[#c1a063] bg-[#14110f] px-1 py-0.5 rounded">-12</code> y pulsa Enter. Se restará solo. Funciona igual con curaciones (<code className="text-[#c1a063] bg-[#14110f] px-1 py-0.5 rounded">+15</code>).</li>
          ...
          <li><strong className="text-[#c1a063]">El Cementerio:</strong> Cuando eliminas a un combatiente lo mandas al cementerio. Quedará guardado en un registro aparte para que puedas consultar sus stats o revivirlo si es necesario.</li>
        </ul>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          <li><strong className="text-[#c1a063]">Misión Raíz vs Submisión:</strong> Creas primero las tramas principales. Usando el botón "+" debajo de cualquier misión puedes crear sub-misiones que quedarán indentadas jerárquicamente debajo de la principal.</li>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          <li><strong className="text-[#c1a063]">Estructura de Carpetas Geográficas:</strong> Ahora puedes organizar tu mundo de forma jerárquica. Por ejemplo: Mapa Continental &gt; Reino &gt; Ciudad &gt; Mazmorra. Haz clic en "Entrar" en cualquier lugar para ver qué contiene.</li>
          <li><strong className="text-[#c1a063]">Mapas Interactivos:</strong> Cada nodo puede tener una "Imagen de Fondo" que actúa como mapa físico. Puedes cargar imágenes desde tu PC o añadir URLs. El visor incluye herramientas de Paneo (arrastrar) y Zoom.</li>
          <li><strong className="text-[#c1a063]">Pins en el Mapa:</strong> Al navegar dentro de un mapa físico que contiene sub-lugares, los verás listados a la derecha. Coloca Pins para asignar a cada sub-lugar una coordenada (X, Y) visual directamente sobre la imagen.</li>
        </ul>
      </div>
    )
  },
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          <li><strong className="text-[#c1a063]">Organización Drag & Drop:</strong> Arrastra y suelta las tarjetas de tus notas para reordenarlas en el tablero visual como más te guste.</li>
          <li><strong className="text-[#c1a063]">Formato Markdown:</strong> Escribe texto enriquecido rápidamente usando símbolos estándar: <code className="text-[#c1a063]"># Título</code>, <code className="text-[#c1a063]">**Negrita**</code>, <code className="text-[#c1a063]">- Lista</code>. Se renderizará perfectamente, con soporte para tablas y saltos de línea.</li>
          <li><strong className="text-[#c1a063]">Codificación por Color:</strong> A cada nota puedes asignarle un color de fondo (Rojo, Verde, Morado...). Así reconoces tus archivos de un vistazo.</li>
        </ul>
      </div>
    )
  },
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          <li><strong className="text-[#c1a063]">Base de Datos SRD 5e:</strong> Todos los conjuros estándar precargados y formateados, con indicadores visuales si requieren componentes Verbales (V), Somáticos (S) o Materiales (M).</li>
          <li><strong className="text-[#c1a063]">Filtros Mágicos:</strong> Usa las barras superiores para aislar conjuros por nivel, Escuela de magia o Clase (Magos, Clérigos, etc).</li>
          <li><strong className="text-[#c1a063]">Favoritos:</strong> Marca tus conjuros más usados (o los de tus enemigos/jugadores) como Favoritos. Aparecerán listados en una sub-pestaña especial para acceso instantáneo durante la sesión.</li>
        </ul>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-4 text-sm text-[#e6e2da] leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2 text-[#8b7355]">
          ...
          <li><strong className="text-[#c1a063]">Buscador Global:</strong> En la barra superior. Si tus jugadores mencionan "El Zafiro Negro", escríbelo ahí y la app buscará en Notas, Objetos, NPCs y Mapas a la vez.</li>
		  ...
		  <li><strong className="text-[#c1a063]">Exportación/Importación Individual:</strong> Cada sub-pestaña tiene su icono de guardar/subir. Puedes descargar un JSON sólo con tus Criaturas y pasárselo a otro máster sin destriparle quiénes son tus NPCs importantes. El sistema permite elegir si <em>Fusionar</em> (añadir a lo que ya tienes) o <em>Sobrescribir</em>.</li>
          <li><strong className="text-[#c1a063]">Exportación Total:</strong> Genera un json para guardar un backup de absolutamente TODO, pasarlo a otro PC, o restaurar la partida tras formatear el ordenador. Al importar, podrás elegir Fusionar (juntar datos) o Sobrescribir (borrar todo y dejar solo lo nuevo).</li>
        </ul>
      </div>
    )
  },
